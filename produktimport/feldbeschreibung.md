...
=== `not_available`
Artikel derzeit nicht erhältlich. <span style="color: #CC0000;">Mit dieser Option wird kein Preis im Shop angezeigt.</span>
=== `tracked`
...
<span style="color: #CC0000;">Mit dieser Option wird kein Preis im Shop angezeigt.</span> Stattdessen hat der Nutzer die Möglichkeit eine manuelle Anfrage durch unseren Einkauf auszulösen.
